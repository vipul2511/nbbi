...
export default function Benefit({ product, userState, getProductDetails, color, isTypeTwoUser }) {
    ...
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 20,fontWeight:'bold',fontFamily: 'Consolas', backgroundColor: 'transparent' }}>ID: {userState.agent ? userState.agent.DIVISION : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 20,fontWeight:'bold',fontFamily: 'Consolas',backgroundColor: 'transparent' }}>BIN: {userState.agent ? userState.agent.DEPARTMENT : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 20,fontWeight:'bold',fontFamily: 'Consolas',backgroundColor: 'transparent' }}>PCN: AE02</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 20,fontWeight:'bold',fontFamily: 'Consolas', backgroundColor: 'transparent' }}>GRP: {userState.agent ? userState.agent.REGION : ""}</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 20,fontWeight:'bold',fontFamily: 'Consolas', backgroundColor: 'transparent' }}>ID: 201906101</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 20,fontWeight:'bold',fontFamily: 'Consolas', backgroundColor: 'transparent' }}>BIN: 021783</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 20,fontWeight:'bold',fontFamily: 'Consolas',backgroundColor: 'transparent' }}>PCN: AE02</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 20,fontWeight:'bold',fontFamily: 'Consolas', backgroundColor: 'transparent' }}>GRP: NDN101</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:'bold', backgroundColor: 'transparent',fontFamily:'Consolas' }}>1.Price your medications at:</Text>
    //                                 </View>
    ...
    //                                     <Text style={{ flex: 1, color: 'red', backgroundColor: 'transparent',fontWeight:'bold',fontFamily:'Consolas' }}>2.Order online or call 855-633-7977 to place your order</Text>
    ...
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:'bold', backgroundColor: 'transparent',fontFamily:'Consolas' }}>3.Your medications ship directly to you.</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:'bold', backgroundColor: 'transparent',fontFamily:'Consolas' }}>2.Order online or call 855-633-7977 to place your order</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    ...
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 60, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 18, fontWeight:"bold",  backgroundColor: 'transparent',fontFamily:'Consolas' }}>ID: {userState.agent ? userState.agent.DIVISION : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 18,fontWeight:"bold",  backgroundColor: 'transparent',fontFamily:'Consolas' }}>BIN: {userState.agent ? userState.agent.DEPARTMENT : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 18, fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>PCN: AE02</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 18, fontWeight:"bold",  backgroundColor: 'transparent',fontFamily:'Consolas' }}>GRP: {userState.agent ? userState.agent.REGION : ""}</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                             <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 10 }} >
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 60, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 18, fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>ID: 201906101</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 18, fontWeight:"bold",  backgroundColor: 'transparent',fontFamily:'Consolas' }}>BIN: 021783</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 18, fontWeight:"bold",  backgroundColor: 'transparent',fontFamily:'Consolas' }}>PCN: AE02</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 18, fontWeight:"bold",  backgroundColor: 'transparent',fontFamily:'Consolas' }}>GRP: NDN101</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    ...
    //                             <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 60 }}>
    //                                     <Text style={{ flex: 1, color: 'red', backgroundColor: 'transparent',fontWeight:"bold",fontFamily:'Consolas' }}>1.Price your medications at:</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    //                                     <Text onPress={() => Linking.openURL('https://www.medaffordglobal.com/' + userState.agent.CODE2)} style={{ flex: 1, color: '#225AE6',fontWeight:"bold", fontFamily:'Consolas', backgroundColor: 'transparent' }}>www.medaffordgloal.com/{userState.agent ? userState.agent.CODE2 : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
    //                                     <Text style={{ flex: 1, color: 'red', backgroundColor: 'transparent',fontFamily:'Consolas',fontWeight:"bold", }}>2.Order online or call 855-633-7977 to place your order</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    //                                     <Text style={{ flex: 1, color: '#225AE6', fontFamily:'Consolas', fontWeight:"bold",backgroundColor: 'transparent' }}>Rx GRP: {userState.agent ? userState.agent.REFERREDBY : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red', backgroundColor: 'transparent',fontFamily:'Consolas',fontWeight:"bold" }}>3.Your medications ship directly to you.</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                             <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 60 }}>
    //                                     <Text style={{ flex: 1, color: 'red', backgroundColor: 'transparent',fontFamily:'Consolas',fontWeight:"bold", }}>1.Price your medications at:</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    //                                     <Text onPress={() => Linking.openURL('https://www.medaffordglobal.com/ndn')} style={{ flex: 1, color: '#225AE6',fontWeight:"bold", fontFamily:'Consolas', backgroundColor: 'transparent' }}>www.medaffordgloal.com/ndn</Text>
    //                                 </View>
    ...
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red', backgroundColor: 'transparent',fontWeight:"bold",fontFamily:'Consolas' }}>3.Your medications ship directly to you.</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:"bold", fontSize: 22, backgroundColor: 'transparent',fontFamily:'Consolas' }}>ID:  {userState.agent ? userState.agent.DIVISION : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:"bold", fontSize: 22, backgroundColor: 'transparent',fontFamily:'Consolas' }}>BIN: {userState.agent ? userState.agent.DEPARTMENT : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:"bold", fontSize: 22, backgroundColor: 'transparent',fontFamily:'Consolas' }}>PCN:  AE02</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:"bold", fontSize: 22, backgroundColor: 'transparent',fontFamily:'Consolas' }}>GRP:  {userState.agent ? userState.agent.REGION : ""}</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                             <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 120, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 22,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>ID:  201906101</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 22,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>BIN:  021783</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 22,fontWeight:"bold",backgroundColor: 'transparent',fontFamily:'Consolas' }}>PCN:  AE02</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 10 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 22,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>GRP:  NDN101</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    ...
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 22,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>1.Price your medications at:</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    ...
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 22, backgroundColor: 'transparent',fontFamily:'Consolas',fontWeight:"bold", }}>2.Order online or call 855-633-7977 to place your order</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    ...
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 22,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>3.Your medications ship directly to you.</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 22,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>2.Order online or call 855-633-7977 to place your order</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    ...
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>ID: {userState.agent ? userState.agent.DIVISION : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 20 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21,fontWeight:"bold",backgroundColor: 'transparent',fontFamily:'Consolas' }}>BIN: {userState.agent ? userState.agent.DEPARTMENT : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 20 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>PCN: AE02</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 20 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>GRP: {userState.agent ? userState.agent.REGION : ""}</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                             <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 6 }} >
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 100, paddingLeft: 20 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21,fontWeight:"bold",backgroundColor: 'transparent',fontFamily:'Consolas' }}>ID: 201906101</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 20 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21,fontWeight:"bold",backgroundColor: 'transparent',fontFamily:'Consolas' }}>BIN: 021783</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 20 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>PCN: AE02</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 20 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21, fontWeight:"bold",backgroundColor: 'transparent',fontFamily:'Consolas' }}>GRP: NDN101</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>1.Price your medications at:</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    ...
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21, backgroundColor: 'transparent',fontWeight:"bold",fontFamily:'Consolas' }}>2.Order online or call 855-633-7977 to place your order</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    ...
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21, backgroundColor: 'transparent',fontWeight:"bold",fontFamily:'Consolas' }}>3.Your medications ship directly to you.</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                             <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 15 }} >
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 100 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21, backgroundColor: 'transparent',fontWeight:"bold",fontFamily:'Consolas' }}>1.Price your medications at:</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    ...
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21, fontWeight:"bold",backgroundColor: 'transparent',fontFamily:'Consolas' }}>2.Order online or call 855-633-7977 to place your order</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    ...
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontSize: 21,fontWeight:"bold", backgroundColor: 'transparent',fontFamily:'Consolas' }}>3.Your medications ship directly to you.</Text>
    ...
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:"bold", fontSize: 18,backgroundColor: 'transparent',fontFamily:'Consolas' }}>GRP: {userState.agent ? userState.agent.REGION : ""}</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:"bold", fontSize: 13,backgroundColor: 'transparent',fontFamily:'Consolas' }}>ID: {userState.agent ? userState.agent.DIVISION : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:"bold", fontSize: 13,backgroundColor: 'transparent',fontFamily:'Consolas' }}>BIN: {userState.agent ? userState.agent.DEPARTMENT : ""}</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:"bold", fontSize: 13,backgroundColor: 'transparent',fontFamily:'Consolas' }}>PCN: AE02</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontWeight:"bold",fontSize: 13,backgroundColor: 'transparent',fontFamily:'Consolas' }}>GRP: {userState.agent ? userState.agent.REGION : ""}</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
    ...
    //                             <TouchableOpacity style={{ flex: 1, alignItems: 'center', padding: 8 }} >
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 48, paddingLeft: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontWeight:"bold",fontSize: 13,backgroundColor: 'transparent',fontFamily:'Consolas' }}>ID: 201906101</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontWeight:"bold",fontSize: 13,backgroundColor: 'transparent',fontFamily:'Consolas' }}>BIN: 021783</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red',fontWeight:"bold", fontSize: 13, backgroundColor: 'transparent',fontFamily:'Consolas' }}>PCN: AE02</Text>
    //                                 </View>
    //                                 <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 1, paddingLeft: 3 }}>
    //                                     <Text style={{ flex: 1, color: 'red', fontWeight:"bold",fontSize: 13,backgroundColor: 'transparent',fontFamily:'Consolas' }}>GRP: NDN101</Text>
    //                                 </View>
    //                             </TouchableOpacity>
    //                         </ImageBackground>
    //                     </View>
